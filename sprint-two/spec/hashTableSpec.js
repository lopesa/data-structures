describe('hashTable', function() {
  ...
  // added test
  it('should return undefined when trying to remove something that does not exist', function() {
    expect(hashTable.retrieve('this doesn\'t exist')).to.equal(undefined);
  });
